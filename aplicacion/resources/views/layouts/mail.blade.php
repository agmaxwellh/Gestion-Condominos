...
<head>
	...
	<style type="text/css">
		...
		.boton{
			text-decoration:none!important; -webkit-text-size-adjust:none;-ms-text-size-adjust:none;color:#FFFFFF !important;
			border-style:solid;border-color:#111827;display:inline-block;background-color:#111827;border-radius:6px;font-family:'Roboto', sans-serif;font-style:normal;text-align:center;
			padding: 1em 3em;
			}
		.boton:hover, .boton:focus {color: #ffffff; background-color: #374151; border-color: #374151; text-decoration: none}
	</style>
			...
			<img src="{{ asset('images/correo-top.jpg') }}" class="image" style="width: 100%">
				<div class="white" style="padding: 3em;">
					...
					<p style="font-size: 0.8em">
						...
						<br> &nbsp;<br>
						Si usted recibió este correo por error, destrúyalo y elimine cualquier copia guardada en su sistema notificando inmediatamente al remitente y/o a infovisaestampada@consuladodepanama.com.ve. Usted no debe utilizar esta información para ningún propósito ajeno al dispuesto por el remitente.</p>
				</div>
